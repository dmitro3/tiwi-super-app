...
export default function TradingChart({
  ...
  // Simulate chart loading (in real app, this would be based on actual chart data loading)
  useEffect(() => {
    // Chart loads quickly, but show skeleton briefly for smooth UX
  ...
  return (
    <div className={`bg-[#010501] border border-[#1f261e] rounded-xl lg:rounded-2xl overflow-hidden backdrop-blur-sm ${className}`}>
      ...
      {/* Chart */}
      <div className="h-[320px] lg:h-[460px] xl:h-[450px] 2xl:h-[500px] bg-[#0b0f0a] flex items-center justify-center overflow-hidden relative">
        {isLoading ? (
