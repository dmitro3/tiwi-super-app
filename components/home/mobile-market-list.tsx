...
export function MobileMarketList({ tokens, isLoading, activeTab, onTabChange }: MobileMarketListProps) {
          ...
          return (
            <div key={tab} className="flex flex-col gap-2.5 h-[26px] items-center shrink-0">
              <button
                ...
                className={`text-xs font-semibold leading-normal transition-colors cursor-pointer ${isActive ? "text-[#b1f128]" : "text-[#b5b5b5]"
                  }`}
              >
                {t(translationKey)}
              </button>
            ...
            >
              <div className="flex flex-[1_0_0] gap-2.5 items-center min-w-0 min-h-0">
                ...
                <div className="flex flex-col items-end justify-center leading-normal shrink-0">
                  ...
                  <p
                    className={`text-xs font-medium ${token.changePositive ? "text-[#3fea9b]" : "text-[#ff5c5c]"
                      }`}
                  >
                    {token.change}
                  </p>
